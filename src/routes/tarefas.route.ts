...
export default () => {
    ...
    router.post('/create', authorization_route('anyUserAuthorized', ['tarefas@create']), tarefas_service.create)
    router.post('/update', authorization_route('anyUserAuthorized', ['tarefas@update']), tarefas_service.update)
    router.post('/delete', authorization_route('anyUserAuthorized', ['tarefas@delete']), tarefas_service.delete)
